...
/* harmony import */ var _regist__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./regist */ "./src/resources/js/regist.js");
...
class SceneMain extends (phaser__WEBPACK_IMPORTED_MODULE_2___default().Scene) {
    ...
    create() {
        ...
        _align_js__WEBPACK_IMPORTED_MODULE_5__["default"].scaleToGameW(jumpBtn, this.game, 0.2);
    ...
    registRank(){
        ...
        if (nick_name.length >= 11 || nick_name.length == 0){
            ...
            rankMng = new _regist__WEBPACK_IMPORTED_MODULE_7__["default"](nick_name, runDist);
            rankMng.setData();
            isRanked = true;
        }
    }
